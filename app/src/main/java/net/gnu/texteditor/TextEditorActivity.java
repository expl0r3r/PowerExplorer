...
public class TextEditorActivity extends SampleActivityBase {//
	...
	SlidingTabsEditorFragment slideFrag;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
            slideFrag = new SlidingTabsEditorFragment();
        } else {
			slideFrag = (SlidingTabsEditorFragment) supportFragmentManager.findFragmentByTag("slideFrag");
		}
