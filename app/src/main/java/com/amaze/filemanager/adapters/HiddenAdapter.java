...
public class HiddenAdapter extends RecyclerArrayAdapter<HFile, HiddenAdapter.ViewHolder> {
    ...
    public HiddenAdapter(Context context, FileFrag mainFrag, Futils utils, @LayoutRes int layoutId,
                            ...
                            if (file.isDirectory()) {
                                ...
                                if (!file.isSmb()) {
                                    context.getActivity().runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            utils.openFile(new File(file.getPath()), (ExplorerActivity) context.getActivity());
                                        }
                                    });
                                }
                            }
