...
//        p1.writeString(lastModifiedStr);
    ...
    private long lastModified = 0,length=0;
//    private String lastModifiedStr = "";
    ...
    public LayoutElements(/*BitmapDrawable imageId, */String name, String path, String permissions,
                          String symlink, /*String lengthStr, */long length, /*boolean header, */long lastModified, boolean isDirectory) {
...
//        }
	...
	public LayoutElements(BaseFile f) {
		this.name = f.getName();
        this.path = f.getPath();
		//Log.d("le", name+", "+path);
        //this.permissions = permissions.trim();
...
//    }
	...
	public boolean equals(Object o) {
		if (o instanceof LayoutElements) {
			return path.equals(((LayoutElements)o).path) && name.equals(((LayoutElements)o).name);
		} else {
			return false;
		}
	}
