...
public class MainActivityHelper {
    ...
    public MainActivityHelper(ExplorerActivity mainActivity) {
     ...
     */
    void mkdir(final OpenMode openMode, final String path, final FileFrag ma) {
     ...
     * @param ma       {@link MainFragment} current fragment
     */
    void mkfile(final OpenMode openMode, final String path, final FileFrag ma) {
...
//        final FileFrag ma = (FileFrag) ((TabFragment) mainActivity.getSupportFragmentManager().findFragmentById(R.id.content_frame)).getTab();
...
//    }
    ...
    public void mkFile(final HFile path, final FileFrag ma) {
    ...
    public void mkDir(final HFile path, final FileFrag ma) {
...
//        final FileFrag ma = (FileFrag) tabFragment.getTab();
...
//        //ma.searchTask = task;
//        SEARCH_TEXT = query;
//        mainActivity.FileFrag = (FileFrag) mainActivity.getFragment().getTab();
