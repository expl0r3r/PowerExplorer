...
public class Futils {
    ...
    public MaterialDialog showNameDialog(final ExplorerActivity m, String[] texts) {
        MaterialDialog.Builder a = new MaterialDialog.Builder(m);
...
//    }
    ...
    public void deleteFiles(ArrayList<LayoutElements> a, final Frag b, /*List<Integer> pos, */AppTheme appTheme) {
        ...
        final StringBuilder dirNames = new StringBuilder();
        final StringBuilder fileNames = new StringBuilder();
        for (int i = 0; i < a.size(); i++) {//pos
            todelete.add(a.get(i).generateBaseFile());//pos.get(
            if(a.get(i).isDirectory())//pos.get(
                dirNames.append("\n")
                        .append(++dirCounter)
                        .append(". ")
					.append(a.get(i).getName());//pos.get(
            else
                fileNames.append("\n")
                        .append(++fileCounter)
                        .append(". ")
					.append(a.get(i).getName())//pos.get(
                        .append(" (")
                        .append(Util.nf.format(a.get(i).length()))//pos.get(
                        .append(")");
        }

        final String titleFiles = b.getResources().getString(R.string.title_files).toUpperCase();
        final String titleDirs = b.getResources().getString(R.string.title_dirs).toUpperCase();
...
//        c.negativeColor(Color.parseColor(b.fabSkin));
        c.callback(new MaterialDialog.ButtonCallback() {
            ...
            public void onPositive(MaterialDialog materialDialog) {
                ...
                b.activity.mainActivityHelper.deleteFiles(todelete);
            }
    ...
    public void showProps(final BaseFile hFile, final String perm, final FileFrag c, boolean root, AppTheme appTheme) {
        ...
        new GenerateMD5Task(materialDialog, hFile, name, parent, items, date,
							c.activity, v).execute(hFile.getPath());
    }

    public void showCloudDialog(final ExplorerActivity mainActivity, AppTheme appTheme, final OpenMode openMode) {
    ...
    public void showEncryptWarningDialog(final Intent intent, final FileFrag main, AppTheme appTheme,
                                         final ArrAdapter.EncryptButtonCallbackInterface
    ...
    public void showEncryptAuthenticateDialog(final Intent intent, final FileFrag main, AppTheme appTheme,
                                              final ArrAdapter.EncryptButtonCallbackInterface
                                                      encryptButtonCallbackInterface) {
    ...
    public void showDecryptFingerprintDialog(final Intent intent, final FileFrag main, AppTheme appTheme,
                                             final ArrAdapter.DecryptButtonCallbackInterface
    ...
    public void showDecryptDialog(final Intent intent, final FileFrag main, AppTheme appTheme,
    ...
    public void openFile(final DocumentFile f, final ExplorerActivity m) {
    ...
    public void showPackageDialog(final File f, final ExplorerActivity m) {
    ...
    public void showArchiveDialog(final File f, final ExplorerActivity m) {
        MaterialDialog.Builder mat = new MaterialDialog.Builder(m);
...
//                            m.openZip(Uri.fromFile(f).toString());
    ...
    public LayoutElements newElement(/*BitmapDrawable i, */String d, String permissions, String symlink, /*String size, */long longSize, boolean directorybool, /*boolean b, */long date) {
    ...
    public void showCompressDialog(final ExplorerActivity m, final ArrayList<BaseFile> b, final String current) {
        MaterialDialog.Builder a = new MaterialDialog.Builder(m);
    ...
    public void showSortDialog(final FileFrag m, AppTheme appTheme) {
...
//    }
    ...
    public void showHistoryDialog(final FileFrag m, AppTheme appTheme) {
    ...
    public void showHiddenDialog(final FileFrag m, AppTheme appTheme) {
        final MaterialDialog.Builder a = new MaterialDialog.Builder(m.getActivity());
        a.positiveText(R.string.cancel);
        a.positiveColor(Color.parseColor(BaseActivity.accentSkin));
    ...
    public void setPermissionsDialog(final View v,View but,final HFile file, final String f, final FileFrag mainFrag) {
