...
public class ForwardCompat
{
    ...
    public static String getImageFileInfoHTML( String path ) { 
        try {
            ...
            case ExifInterface.ORIENTATION_ROTATE_90:       os =  "90Â°";        break;
            case ExifInterface.ORIENTATION_ROTATE_270:      os = "270Â°";        break;
            case ExifInterface.ORIENTATION_ROTATE_180:      os = "180Â°";        break;
